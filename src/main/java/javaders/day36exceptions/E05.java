...
varligi ile ilgilidir. Her iki exception compile time exception olarak bilinirler. Birlikte kullanildiklarinda child exception ustte, IOException altta kullanilmalidir.
    ...
    public static void main(String[] args) throws IOException {
        /*
        Exceptionlar ikiye ayrılır;
        Run time Exceptionlar ve Compile Time Exceptionlar.
        -cha
         */
        ...
        int k = 0;
         while ((k=fis.read())!= -1){//while ((k=fis.read())!=-1){ // fis objem uzerinden txt.dosyadan okudugum karakterler -1 e esit olmadigi surece okumaya devam et
             System.out.print((char)k);//(char)k yaparak sayıyıs harfe çevirdik. Type Casting
         }
